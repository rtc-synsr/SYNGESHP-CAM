...
export default function SyngespCamApp({
  ...
  const handleExportBulletinPDF = (patient) => {
    ...
    try {
      ...
      doc.text("SYNGESHP-CAM — Système Numérique de Gestion Hospitalière & Planification (PSNSN 2026-2030)", 14, 25);
  ...
  const handleExportFacturePDF = (fac) => {
    ...
    try {
      ...
      doc.setFontSize(9);
      doc.setFont("helvetica", "normal");
      doc.text("SYNGESHP-CAM — Quittance Officielle de Prestations Hospitalières & CSU", 14, 25);
      try {
        const logoHosp = localStorage.getItem("rtc_client_logo") || "data:image/png;base64,";
        doc.addImage(logoHosp, "PNG", 175, 4, 24, 24);
      } catch (eHosp) {}
    ...
    <div className="w-full min-h-screen bg-[#0A1A22] text-[#EAF2F4] flex flex-col font-sans">
      ...
      <header className="px-6 py-3 bg-[#1E1F29] border-b border-[#2E3040] flex items-center justify-between sticky top-0 z-30 shadow-md">
        <div className="flex items-center gap-3">
          ...
          <div className="w-9 h-9 rounded-lg bg-[#00A09D]/20 border border-[#00A09D]/40 flex items-center justify-center text-[#5FC2D6] shrink-0">
            <HeartPulse size={20} className="text-[#00A09D]" />
          </div>
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-base font-bold text-white tracking-wide flex items-center gap-1.5" style={{ fontFamily: "Rajdhani, sans-serif" }}>
                <span>SYNGESHP-CAM</span>
